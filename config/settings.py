...
SECRET_KEY = "django-insecure-d+)4a-aie$f)(2xg(&_@e6ip0@-hk3$cw%^nqkb)$#x&_3ghqn"
...
DEFAULT_FROM_EMAIL = os.getenv('EMAIL_HOST_USER', 'noreply@vehicules.tg')
...
# Taille max upload : 50MB (photos + vidéos véhicules)
